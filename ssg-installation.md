...
1. What we've done now is isolate the files you're working on that are actually part of the web site -- everything else, like `.eleventy.js` and `package.json` are about how you are making the site, but they aren't directly related to things the user will see or experience in the browser.
...
17. Let's verify everything works; type `npm build` to get your project rebuilt with this new structure; you should now see a `dist` folder with your HTML and CSS.
